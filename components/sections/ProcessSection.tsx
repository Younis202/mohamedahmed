    ...
    <section className="relative py-24 lg:py-32 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <motion.div
          ...
          animate={{
            background: [
              "radial-gradient(circle at 20% 30%, rgba(251, 146, 60, 0.08) 0%, transparent 70%)",
              "radial-gradient(circle at 80% 70%, rgba(245, 101, 101, 0.06) 0%, transparent 70%)",
              "radial-gradient(circle at 40% 90%, rgba(168, 85, 247, 0.04) 0%, transparent 70%)",
              "radial-gradient(circle at 20% 30%, rgba(251, 146, 60, 0.08) 0%, transparent 70%)",
            ],
          }}
      ...
      <div className="relative container mx-auto px-6 lg:px-8">
            ...
            >
              <div className="relative">
                ...
                {index < steps.length - 1 && (
                  <div className="absolute left-8 top-20 w-0.5 h-16 bg-gradient-to-b from-orange-200 to-pink-200 z-0" />
                )}

                <div className="relative bg-white/70 backdrop-blur-xl border border-orange-100 rounded-2xl p-8 shadow-lg shadow-orange-500/5 hover:shadow-xl hover:shadow-orange-500/10 transition-all duration-300">
                  <div className="flex items-start gap-6">
                    {/* Step Number & Icon */}
                    <div className="flex flex-col items-center space-y-4">
                      <div
                        className={`w-16 h-16 bg-gradient-to-r ${step.iconBg} rounded-2xl flex items-center justify-center shadow-sm`}
                      >
                        <step.icon
        ...
        >
          <div className="bg-gradient-to-br from-orange-500 to-red-500 rounded-2xl p-8 shadow-xl shadow-orange-500/20">
