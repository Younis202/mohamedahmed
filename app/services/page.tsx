          ...
          >
            ...
            <div className="bg-white/70 backdrop-blur-xl border border-orange-100 rounded-3xl p-8 lg:p-12 shadow-xl shadow-orange-500/5">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                {[
                  { step: "1", title: "Consultation", description: "Free on-site assessment and detailed quote", icon: MessageSquare, gradient: "from-orange-400 to-red-500" },
                  { step: "2", title: "Planning", description: "Color selection and project timeline", icon: Calendar, gradient: "from-purple-400 to-pink-500" },
                  { step: "3", title: "Preparation", description: "Surface prep and area protection", icon: Paintbrush, gradient: "from-blue-400 to-indigo-500" },
                  { step: "4", title: "Execution", description: "Expert painting and finishing touches", icon: Sparkles, gradient: "from-green-400 to-emerald-500" }
                ].map((phase, index) => (
                  <motion.div
                    key={index}
                    variants={fadeInUp}
